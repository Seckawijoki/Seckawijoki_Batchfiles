...
set mDirCurrentProjAndroid=Proj.Android.MiniBeta
 
%PATH_AUTOMATIC_BUILD%\automatic_build_entrance.bat %DIR_TRUNK% %DIR_ENV_1% %mPathNdkBuildCmd%  %mNdkBuildAbi% %mApkVersionName% 9  %mDirCurrentProjAndroid%
